...
import hendrifbs.restful.model.request.UpdateContactRequest;
...
import hendrifbs.restful.model.request.CreateContactRequest;
import hendrifbs.restful.model.response.ContactResponse;
...
import hendrifbs.restful.repository.UserRepository;
...
class ContactControllerTest {
    ...
    void getContactNotFound() throws Exception {
        mockMvc.perform(
                get("/api/v1/contacts/23123123123")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
        ).andExpectAll(
    ...
    void deleteContactNotFound() throws Exception {
        mockMvc.perform(
                delete("/api/v1/contacts/23123123123")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
        ).andExpectAll(
